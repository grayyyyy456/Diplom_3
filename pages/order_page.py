...
class OrderPage(BasePage):
    ...
    @allure.step("Ожидание исчезновения крестика")
    def wait_exit_to_disappear(self, timeout=20):
        return self.wait_for_element_to_disappear(OrderLocators.window_exit_order, timeout)